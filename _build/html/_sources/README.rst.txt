...
The program is used for fault detection and diagnosis of graph based networks. The implementation is based on qubo explained in `paper <https://arxiv.org/pdf/1406.7601.pdf>`_.
